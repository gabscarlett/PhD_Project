function [a_m,a_pm] = BEM_steady3D_0(U0,TSR,Nb,r,c,B,Values_360r)
...
%               calculate initial inflow angle
            ...
            %Alpha=Values_360.Alpha{i};
%             Cl=Values_360.Cl_360{i};
%             Cd=Values_360.Cd_360{i};
